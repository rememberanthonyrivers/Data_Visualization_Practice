...
print("Total repositories:", response_dict["total_count"]) # represents the toal num of repos on github

# Explore information about the repositories
repo_dicts = response_dict['items'] # list containing a number of dictionaries 
